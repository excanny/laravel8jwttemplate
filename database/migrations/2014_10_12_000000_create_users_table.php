...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('profile_image',150)->default('User DP.png');
            ...
            $table->string('preferred_job1',80)->nullable();
            $table->string('preferred_job2',80)->nullable();
            $table->string('preferred_job3',80)->nullable();
            $table->string('preferred_job4',80)->nullable();
